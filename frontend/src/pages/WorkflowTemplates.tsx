        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-6 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500"
            />
          </div>
          <select
            value={filterCategory}
            onChange={(e) => setFilterCategory(e.target.value)}
            className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 min-w-[160px] flex-shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTemplates.map((template) => (
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4 line-clamp-2" title={template.description || ''}>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-900 break-words">{detailTemplate.name}</p>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Category</label>
                  <span className={`inline-block text-xs px-2 py-1 rounded-full bg-${getCategoryColor(detailTemplate.category)}-100 text-${getCategoryColor(detailTemplate.category)}-700`}>
                ...
                <div>
                  ...
                  <p className="text-gray-900 break-words">{detailTemplate.description || 'No description available'}</p>
                </div>

                {detailTemplate.tags && detailTemplate.tags.length > 0 && (
                  <div>
                    <label className="block text-sm font-medium text-gray-500 mb-1">Tags</label>
                    <div className="flex flex-wrap gap-1">
                      {detailTemplate.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="inline-flex items-center px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded"
                        >
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Usage</label>
                  <p className="text-gray-900">Used {detailTemplate.usage_count} times</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button
                  onClick={() => {
                    setShowDetailModal(false);
                    openTemplateModal(detailTemplate);
                  }}
