-- ============================================================
-- Add company_id to Missing Tables
-- ============================================================
...
-- ============================================================
-- 5. teams (if it should be company-specific)
-- ============================================================
\echo '5. Adding company_id to teams...'

-- Add column
ALTER TABLE teams 
ADD COLUMN IF NOT EXISTS company_id UUID;

-- Populate from first user in team (if user_id exists)
UPDATE teams 
SET company_id = (
    SELECT company_id FROM users 
    WHERE users.id = teams.created_by 
    LIMIT 1
)
